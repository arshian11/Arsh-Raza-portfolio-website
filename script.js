...
document.querySelectorAll('.project-link').forEach(link => {
    link.addEventListener('click', (e) => {
        ...
        const linkType = e.target.closest('.project-link').querySelector('i').classList.contains('fa-github') ? 'GitHub' : 'Live Demo';
        
        // You can add analytics tracking here
        console.log(`Clicked ${linkType} for ${projectTitle}`);
    });
});
